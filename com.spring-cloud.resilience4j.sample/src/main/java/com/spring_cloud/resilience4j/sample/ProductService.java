...
public class ProductService {
    ...
    private final Logger log = LoggerFactory.getLogger(getClass()); //로그 보기위해서 사용
    private final CircuitBreakerRegistry circuitBreakerRegistry; //그냥 가져다 쓰면 된다.

    //서킷브레이커 상에서는 상태변화를 볼 수 없으므로 이벤트리스너를 통해서 상태변화를 본다.
    @PostConstruct
